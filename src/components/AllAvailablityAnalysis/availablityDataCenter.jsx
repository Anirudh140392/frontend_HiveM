...
const ENTITY_DATA = {
  ...
  "baskin robbins": { offtakes: 2.85, spend: 0.45, roas: 13.0, categorySize: 13.0, conversion: 2.5, availability: 78.2, sos: 10.3, marketShare: 13.0, price: 274.0, inorgSales: 8.8, dspSales: 5.2, promoMyBrand: 16.5, promoCompete: 14.2, cpm: 158, osa: 78.2, doi: 42, fillrate: 84.5, assortment: 112 },
...
function getLogicalKpiValue(kpi, filters = {}) {
  ...
  const isTotalizing = ['offtaking', 'offtake', 'offtakes', 'spend', 'inorgsales', 'dspsales', 'categorysize', 'psl'].includes(rawKey);
