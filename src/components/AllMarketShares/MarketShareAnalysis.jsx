...
import { MARKET_SHARE_DATA } from "../../utils/hardcodedData";
...
const subCategoryBrandHeat = {
  Candies: [
    ...
    { brand: "Hiveminds", values: [3, 3, 4, 3, 3, 3, 4, 3, 3] },
  ],
  'Filled Bars': [
  ...
  'Gift Packs': [
    ...
    { brand: "Hiveminds Assorted", values: [6, 5, 6, 5, 6, 5, 6, 5, 6] },
  ],
  Others: [
...
export default function MarketShareAnalysis() {
  ...
  useEffect(() => {
    // Use imported MARKET_SHARE_DATA
